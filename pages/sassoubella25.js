    ...
    <>
      <Head>
        ...
        <script
          async
          defer
          src="https://tools.luckyorange.com/core/lo.js?site-id=5e7fce81"
        ></script>

        <script
          async
          src="https://c.opfourpro.com/8/js/script.js?id=H9PHh"
        ></script>
        <meta
          name="description"
      ...
      <div className="relative lg:w-5/12 lg:m-auto">
        ...
        <div className="text-[#e6e6fa]  w-[90%] m-auto my-4 text-center">
          <p className="py-2 font-medium ">
            ...
            <br></br>
            <br></br>Si tu es intéressé, inscris toi ici et envoie moi un
            message
            <br></br>
            👇👇👇
          </p>
        ...
        <footer className="">
          <div className="w-[90%] m-auto text-center text-white text-sm">
            ...
            <div>
              ...
              d'essai ! <br></br>
              <br></br>Il te suffit de cliquer sur le bouton ci-dessous, de
